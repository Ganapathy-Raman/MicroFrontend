...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        if (result) {
            ...
            if (userName === 'Admin' && password === 'Admin@777') {
    ...
    return (
        ...
        <Nav />
            ...
            <div className="form-container">
                <p className="title"><center>Login</center></p>
                <form onSubmit={handleLogin}>
                    <div className="input-group">
                    <IoMdPerson className="text-xl" />Username<label htmlFor="username"></label>
                        <input
                            type="text"
                            id="username"
                            value={userName}
                    ...
                    <div className="input-group checkbox-group">
                        ...
                        />
                        <label htmlFor="rememberMe">Remember and keep me signed in !</label>
                    </div>
